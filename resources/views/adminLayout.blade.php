...
<!-- font CSS -->
<link href='{{asset('public/Back-end/fonts.googleapis.com/css?family=Roboto:400,100,100italic,300,300italic,400italic,500,500italic,700,700italic,900,900italic')}}' rel='stylesheet' type='text/css'>
<!-- font-awesome icons -->
    ...
    <ul class="nav top-menu">
        ...
        <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="{{asset('public/Back-end/images/3.png')}}"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="{{asset('public/Back-end/images/1.png')}}"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="{{asset('public/Back-end/images/2.png')}}"></span>
                                <span class="subject">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    <a href="javascript:;">
                        ...
                        <span>Category Operation</span>
                    </a>
                    <ul class="sub">
                        <li><a href="{{URL::to('/addCategory')}}">Add New Product Categories</a></li>
                        <li><a href="{{URL::to('/allCategory')}}">Product Categories List</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
                        <li><a href="{{URL::to('/addBrand')}}">Add New Product Brand</a></li>
                        <li><a href="{{URL::to('/allBrand')}}">Product Brand List</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                        <i class="fa fa-book"></i>
                        <span>Product Operation</span>
                    </a>
                    <ul class="sub">
                        <li><a href="{{URL::to('/addProduct')}}">Add New Product </a></li>
                        <li><a href="{{URL::to('/allProduct')}}">Product List</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
						<li><a href="typography.html">Add User</a></li>
...
<!-- calendar -->
	<script type="text/javascript" src="{{asset('public/Back-end/js/monthly.js')}}"></script>
